...
public class Restaurant_Management {
    ...
    public static String[] place_Order() {
        ...
        Scanner input = new Scanner(System.in);
        String[] arr;
        int order_no = (int) (Math.random() * 10);
        ...
        int table = (int) (Math.random() * (20 - 1+1)-1);
        int number_of_order;
        ...
        if (member==1) {
            member_billing(arr, table, time, order_no);
        }
        else {
            billing(arr,table,time,order_no);
        }
        return arr;
    }
        ...
        try {
            ...
            if (option == 1) {
                ...
                if (isCheck) {
                    ...
                    System.out.println("it is not a valid social security number\nyour number should in the form of DDD-DD-DDDD\nplease enter again");
            } else if (option == 2) {
...
app();
    ...
    public static Connection getConnection() {  // for connecting database
        try {
            ...
            String databaseurl = "jdbc:mysql://localhost:3306/restaurent_management_app";
...
static void GUI_interface(){
    ...
    static JFrame inter(){
        ...
        frame.setTitle("MILLENNIUM RESTAURANT APP");
